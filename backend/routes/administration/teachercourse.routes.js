module.exports = app => {
  const teachercourse = require("../../controllers/administration/teachercourse.controller")
  ...
  router.get("/teachernotinagroup/:groupId", auth.isAuthenticated, teachercourse.findAllTeachersNotInAGroup);
